...
import com.example.my_boilerplate.common.managers.SharedPrefsManager;
...
import com.example.my_boilerplate.di.NetworkModule_ProvideMoshiFactory;
import com.example.my_boilerplate.di.NetworkModule_ProvideOkHttpClientFactory;
import com.example.my_boilerplate.di.NetworkModule_ProvideProductApiServiceFactory;
import com.example.my_boilerplate.di.NetworkModule_ProvideRetrofitFactory;
...
import com.example.my_boilerplate.home.presentation.ui.HomeFragment;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_my_boilerplate_home_presentation_viewmodels_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectLoginEventBus(instance, singletonCImpl.loginEventBusProvider.get());
      return instance;
    }

    @IdentifierNameString
    private static final class LazyClassKeyProvider {
      static String com_example_my_boilerplate_home_presentation_viewmodels_HomeViewModel = "com.example.my_boilerplate.home.presentation.viewmodels.HomeViewModel";

      @KeepFieldType
      HomeViewModel com_example_my_boilerplate_home_presentation_viewmodels_HomeViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_my_boilerplate_home_presentation_viewmodels_HomeViewModel, ((Provider) homeViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.my_boilerplate.home.presentation.viewmodels.HomeViewModel 
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private Provider<LoginEventBus> loginEventBusProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.loginEventBusProvider = DoubleCheck.provider(new SwitchingProvider<LoginEventBus>(singletonCImpl, 2));
      ...
      this.provideProductApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<ProductApiService>(singletonCImpl, 4));
      this.networkMonitorProvider = DoubleCheck.provider(new SwitchingProvider<NetworkMonitor>(singletonCImpl, 9));
      this.productRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 3);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.my_boilerplate.common.managers.ThemeManager 
          return (T) new ThemeManager(singletonCImpl.sharedPrefsManagerProvider.get());

          case 1: // com.example.my_boilerplate.common.managers.SharedPrefsManager 
          ...
          case 2: // com.example.my_boilerplate.common.bus.LoginEventBus 
          return (T) new LoginEventBus();

          case 3: // com.example.my_boilerplate.home.data.repository.ProductRepositoryImpl 
          return (T) new ProductRepositoryImpl(singletonCImpl.provideProductApiServiceProvider.get(), singletonCImpl.networkMonitorProvider.get());

          case 4: // com.example.my_boilerplate.home.data.remote.ProductApiService 
          ...
          case 7: // com.example.my_boilerplate.core.session.SessionManager 
          return (T) new SessionManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.loginEventBusProvider.get());

          case 8: // com.squareup.moshi.Moshi 
          return (T) NetworkModule_ProvideMoshiFactory.provideMoshi();

          case 9: // com.example.my_boilerplate.core.network.NetworkMonitor 
